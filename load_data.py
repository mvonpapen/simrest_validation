'''
Functions to load experimental and simulated data 
RestingState IO functions

This module can be used to load the resting state data using the
Blackrock loading IO of neo.

Author: Michael Denker, Mitch von Papen
Date:   14.09.2017
'''
